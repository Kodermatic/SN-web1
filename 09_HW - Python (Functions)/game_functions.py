...
my_path = "./09_HW - Python (Functions)"
...
def top_scores(f_path_filename, f_no_of_top_scores, f_sorted_by="attemps"):      # Function print top x results
  ...
  for i in f_sorted_lists:
    f_top_scores = f"{n}.)    attemps: {i['attemps']}    secret: {i['secret']}    level: {i['level']}   date: {i['date']} \n"
